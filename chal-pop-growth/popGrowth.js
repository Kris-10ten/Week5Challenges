...
// inhabitants per year come to live in the town. How many years does the 
...
function nbYear (initialPop, percent, aug, popGoal) {
    let years = 0
    while (initialPop < popGoal) {
        initialPop += initialPop * (percent/100) + aug
        years ++
    }
    return years
}
...
console.log(nbYear(1000, 2, 91, 1570))
console.log(nbYear(75, 2, 67, 4000))